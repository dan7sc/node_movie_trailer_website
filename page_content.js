/**
 * A set of strings ot store html content
 */
    ...
    <div class="anime col-sm-6 col-md-4 col-lg-3 text-center">
        <div class="card">
          <img class="card-img-top" ` +
                    `src="{posterImageUrl}" width=220 height=342>
            <div class="card-body">
                <div class="card-title">
                    <h4>{movieTitle}</h4>
                    <div class="card-option">
                        <a id="play-trailer" ` +
                    `data-trailer-youtube-id="{trailerYoutubeId}" ` +
                    `data-toggle="modal" data-target="#trailer">Trailer</a>
                    </div>
                    <div class="card-option">
                        <a id="info-data" data-toggle="modal" ` +
                    `data-target="#info" data-title="{movieTitle}" ` +
                    `data-storyline="{movieStoryline}" ` +
                    `data-released="{movieReleased}" ` +
                    `data-runtime="{movieRuntime}" ` +
                    `data-genre="{movieGenre}" ` +
                    `data-director="{movieDirector}" ` +
                    `data-rated="{movieRated}" ` +
                    `data-rating="{movieRating}">Info</a>
                    </div>
                </div>
            </div>
        </div>
...
module.exports = {
  mainPageHead, mainPageStyles, mainPageScripts,
  mainPageContent, movieCardContent
};
